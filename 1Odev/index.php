<?php
    ...
    $yeni_film = array(
        "baslik" => "Lucifer",
            "aciklama" => "Zombİ kıyametinin ardından hayatta kalanlar, birlikte verdikleri ölüm kalım mücadelesinde insanlığa karşı duydukları umuda tutunur.",
            "resim" => "3.jpeg",
            "yorumSayisi" => "Yorum: 55",
            "begeniSayisi" => "Beğeni: 85",
            "vizyon" => "Viyonda: Evet"
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                <?php echo substr($yeni_filmler = ucfirst(strtolower($filmler["1"]["aciklama"])), 0 , 50) . "..."; ?>
                                </p>
                                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                <?php echo substr($yeni_filmler = ucfirst(strtolower($filmler["2"]["aciklama"])), 0 , 50) . "..."; ?>
                                </p>
                                <div>
                                    <span class="badge bg-success">Yapım Tarihi: 03.12.2021</span>
