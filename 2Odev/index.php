...
function filmEkle(&$filmler, string $baslik, string $aciklama, string $resim, int $yorumSayisi = 0, int $begeniSayisi = 0, bool $vizyon = false, $url = "demo") {
    ...
    $filmler[count($filmler) + 1] = $new_item;
}
...
<body>
    <div class="container my-3">
        <div class="row">
            ...
            <div class="col-9">
                <?php foreach($filmler as $id => $film): ?> <!-- tüm divi foreach icine aldik -->
                    <div class="card mb-3">
                        <div class="row">
                            <div class="col-3">
                                <img class="img-fluid" src="img/<?php echo $film["resim"]; ?>"> <!-- resim icin php kullanimi -->
                            </div>
                            <div class="col-9">
                                <div class="card-body">
                                    <h5 class="card-title">
                                    ...
                                    <div>
                                        ...
                                        <?php if($film["yorumSayisi"] > 0): ?>
                                            <span class="badge bg-success"><?php echo $film["yorumSayisi"]; ?> yorum</span> <!-- yorum icin php kullanimi -->
                                        <?php endif; ?>
                                        <span class="badge bg-success"><?php echo $film["begeniSayisi"]; ?> beğeni</span> <!-- begeni icin php kullanimi -->
                ...
                <?php endforeach; ?> <!-- tüm divi foreach icine aldik (bitisi) -->
            </div>
        </div>
    </div>
</body>
